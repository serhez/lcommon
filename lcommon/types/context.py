...
"""
A single message with provider-specific fields, such as `role` for OpenAI's models.
...
"""A list of messages with provider-specific fields forming a conversation."""
